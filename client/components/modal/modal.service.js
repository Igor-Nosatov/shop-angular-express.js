          ...
          return function() {
            ...
            deleteModal = openModal({
              modal: {
                ...
                html: '<p>Ви впевнені, що хочете видалити<strong>' + name + '</strong> ?</p>',
                buttons: [{
                  classes: 'btn-danger',
                  text: 'Delete',
                  click: function(e) {
          ...
          return function() {
            ...
            deliverModal = openModal({
              modal: {
                ...
                html: '<p>Ви впевнені, що хочете доставити <strong>' + name + '</strong> ?</p>',
                buttons: [{
                  classes: 'btn-success',
                  text: 'Deliver',
                  click: function(e) {
          ...
          return function() {
            ...
            deliverModal = openModal({
              modal: {
                ...
                html: '<p>Ви впевнені, що хочете обробити?<strong>' + name + '</strong> ?</p>',
                buttons: [{
                  classes: 'btn-success',
                  text: 'Process',
                  click: function(e) {
